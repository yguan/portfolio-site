...
define(function (require, exports, module) {
    ...
    var level = {
        ...
        data = {
            languages: [
                { name: 'HTML', years: [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 11, level: level.veryProficient },
                { name: 'CSS', years: [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 11, level: level.proficient },
                { name: 'JavaScript', years: [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 11, level: level.veryProficient },
                { name: 'C#', years: [2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 9, level: level.veryProficient },
                { name: 'Transact-SQL', years: [2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 8, level: level.proficient },
            ...
            dotNet: [
                { name: '.NET 4.5', years: [2013, 2014], duration: 1, level: level.proficient },
            ...
            database: [
                ...
                { name: 'SQL Server 2005', years: [2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 7, level: level.proficient },
            ...
            frontEnd: [
                { name: 'Ext JS 4.1 & 4.2', years: [2013, 2014], duration: 1.3, level: level.proficient },
            ...
            sourceControl: [
                { name: 'TFS', years: [2011, 2012, 2013, 2014], duration: 3, level: level.proficient },
                { name: 'Git', years: [2012, 2013, 2014], duration: 1.5, level: level.someExperience },
            ...
            ci: [
                { name: 'TFS', years: [ 2013, 2014], duration: 1.3, level: level.someExperience },
            ...
            ide: [
                { name: 'Resharper (8, 7, 6, 5, 4, 3)', years: [2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014], duration: 8.5, level: level.someExperience },
                { name: 'Visual Studio.NET 2012', years: [2012, 2013, 2014], duration: 1.5, level: level.proficient },
